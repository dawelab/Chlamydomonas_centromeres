...
chr_01 <- read.table('cc1690_cc5816_chr_01.blast.txt.sub', sep="\t", fill=TRUE)
chr_02 <- read.table('cc1690_cc5816_chr_02.blast.txt.sub', sep="\t", fill=TRUE)
chr_02T <- read.table('cc1690_cc5816_chr_02T.blast.txt.sub', sep="\t", fill=TRUE)
chr_03 <- read.table('cc1690_cc5816_chr_03.blast.txt.sub', sep="\t", fill=TRUE)
chr_04 <- read.table('cc1690_cc5816_chr_04.blast.txt.sub', sep="\t", fill=TRUE)
chr_05 <- read.table('cc1690_cc5816_chr_05.blast.txt.sub', sep="\t", fill=TRUE)
chr_06 <- read.table('cc1690_cc5816_chr_06.blast.txt.sub', sep="\t", fill=TRUE)
chr_07 <- read.table('cc1690_cc5816_chr_07.blast.txt.sub', sep="\t", fill=TRUE)
chr_08 <- read.table('cc1690_cc5816_chr_08.blast.txt.sub', sep="\t", fill=TRUE)
chr_09 <- read.table('cc1690_cc5816_chr_09.blast.txt.sub', sep="\t", fill=TRUE)
chr_10 <- read.table('cc1690_cc5816_chr_10.blast.txt.sub', sep="\t", fill=TRUE)
chr_11 <- read.table('cc1690_cc5816_chr_11.blast.txt.sub', sep="\t", fill=TRUE)
chr_12 <- read.table('cc1690_cc5816_chr_12.blast.txt.sub', sep="\t", fill=TRUE)
chr_13 <- read.table('cc1690_cc5816_chr_13.blast.txt.sub', sep="\t", fill=TRUE)
chr_14 <- read.table('cc1690_cc5816_chr_14.blast.txt.sub', sep="\t", fill=TRUE)
chr_15 <- read.table('cc1690_cc5816_chr_15.blast.txt.sub', sep="\t", fill=TRUE)
chr_16 <- read.table('cc1690_cc5816_chr_16.blast.txt.sub', sep="\t", fill=TRUE)
chr_17 <- read.table('cc1690_cc5816_chr_17.blast.txt.sub', sep="\t", fill=TRUE)

data_list <- c("chr_01","chr_02","chr_02T","chr_03","chr_04","chr_05","chr_06","chr_07","chr_08","chr_09","chr_10","chr_11","chr_12","chr_13","chr_14","chr_15","chr_16","chr_17")
...
chr_01_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_01.png", plot=chr_01_dotplot, width=10, height=10) 
...
chr_02_dotplot <- ggplot() +
  ...
  geom_rect(data=filter(ZeppL_1690,ZeppL_1690$Chr=="chr_02",ZeppL_1690$Start<8400000),aes(xmin = min(chr_02$sbin_start)-4000*2, xmax = min(chr_02$sbin_start)-4000, ymin=Start, ymax = End,fill=Type)) +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_02_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_02.png", plot=chr_02_dotplot, width=10, height=10) 

#chr_02_tail
chr_02T_dotplot <- ggplot() +
  geom_point(data=chr_02T, aes(x=sbin_start+sstart, y=qbin_start, colour=bitscore),size=0.5) +
  geom_rect(data=filter(ZeppL_1690,ZeppL_1690$Chr=="chr_02",ZeppL_1690$Start>8400000),aes(xmin = min(chr_02T$sbin_start)-4000*2, xmax = min(chr_02T$sbin_start)-4000, ymin=Start, ymax = End,fill=Type)) +
  geom_rect(data=filter(ZeppL_5816,ZeppL_5816$Chr=="chr_02",ZeppL_5816$Start>8400000),aes(xmin = Start, xmax = End, ymin=8405143-4000*2, ymax = 8405143-4000,fill=Type)) +
  scale_fill_manual(values = c("white","grey","black"),labels=c("","Non ZeppL","ZeppL"))+
  geom_segment() +
  scale_colour_gradient(low="#FDE725FF", high="#440154FF") +
  theme_bw() +
  #xlab('CC5816 Chr_02T  ') + ylab(' UL1690.1 Chr_02T  ') +
  xlab('') + ylab('') +
  scale_x_continuous(breaks =seq(8424698,8497198,50000))+
  scale_y_continuous(breaks =seq(8405143,8477643,50000))+
  coord_fixed() +
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_02T_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_02T.png", plot=chr_02T_dotplot, width=10, height=10) 
...
chr_03_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_03_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_03.png", plot=chr_03_dotplot, width=10, height=10) 
...
chr_04_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_04_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_04.png", plot=chr_04_dotplot, width=10, height=10) 
...
chr_05_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_05_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_05.png", plot=chr_05_dotplot, width=10, height=10) 
...
chr_06_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_06_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_06.png", plot=chr_06_dotplot, width=10, height=10) 
...
chr_07_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_07_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_07.png", plot=chr_07_dotplot, width=10, height=10)  
...
chr_08_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_08_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_08.png", plot=chr_08_dotplot, width=10, height=10) 
...
chr_09_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_09_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_09.png", plot=chr_09_dotplot, width=10, height=10) 
...
chr_10_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_10_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_10.png", plot=chr_10_dotplot, width=10, height=10) 
...
chr_11_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_11_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_11.png", plot=chr_11_dotplot, width=10, height=10) 
...
chr_12_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_12_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_12.png", plot=chr_12_dotplot, width=10, height=10) 
...
chr_13_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_13_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_13.png", plot=chr_13_dotplot, width=10, height=10) 
...
chr_14_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_14_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_14.png", plot=chr_14_dotplot, width=10, height=10) 
...
chr_15_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_15_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_15.png", plot=chr_15_dotplot, width=10, height=10) 
...
chr_16_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_16_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_16.png", plot=chr_16_dotplot, width=10, height=10) 
...
chr_17_dotplot <- ggplot() +
  ...
  theme(legend.position = "none",axis.text = element_text(size = 20))
chr_17_dotplot
ggsave(file="Figure_cc1690_cc5816_updated/chr_17.png", plot=chr_17_dotplot, width=10, height=10) 
